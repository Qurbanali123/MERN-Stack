...
export default function Home() {
  ...
  const wordpressProjects = [
    { name: "Wynd Group", url: "https://wynd.group/", category: "Business Group" },
  ...
  <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center justify-between">
    <div className="flex-1">
      ...
      <ul className="space-y-4">
        {[
          "Assisted in frontend and backend web development tasks",
          "Built responsive and user-friendly web interfaces",
          "Supported REST API integration",
          "Customized and managed WordPress websites",
          "Updated website content and improved functionality",
          "Collaborated with senior developers on live projects",
          "Enhanced website performance and optimization"
        ].map(item => (
...
{/* Experience Section (Brief) */}
<section id="experience" className="py-24 px-6 border-t border-white/5">
  <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-start md:items-center justify-between">
      ...
      <section id="contact" className="py-24 md:py-40 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-slate-400 text-lg mb-12 max-w-xl mx-auto">
            I&apos;m currently available full-time engineering roles. 
